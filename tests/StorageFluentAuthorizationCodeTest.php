...
use Mockery as m;
use Microweber\OAuth2\Entity\Scope as ScopeEntity;
use Microweber\OAuth2\Entity\AuthorizationCode as AuthorizationCodeEntity;
use Microweber\OAuth2\Storage\Fluent\AuthorizationCode as AuthorizationCodeStorage;
